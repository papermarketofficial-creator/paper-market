...
const LogoLearn: React.FC<LogoProps> = ({ className = "", hideText = false }) => {
  return (
    <div className={`flex items-center gap-2.5 ${className}`}>
      {/* The Icon SVG - Kept identical to the main logo for brand consistency */}
      <svg
