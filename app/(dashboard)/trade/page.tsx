...
export default function TradePage() {
  ...
  // Consolidate all instruments or fetch based on active tab?
  // For now, load equity default, but this should ideally be global
                ...
                <div className="relative">
                  ...
                  <div className="h-auto max-h-[80vh] overflow-y-auto rounded-lg border border-border bg-card">
                     <TradingForm
                        ...
                        instruments={currentInstruments}
                        instrumentMode="equity" // Defaulting to equity for now, needs context
                      />
                  </div>
                </div>
             </div>
